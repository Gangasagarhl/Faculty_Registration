...
/*
? in response entity telling the response entity body can be of any type.

Get the data from the admin posted data and store it  the admin entity.
Finally check  whether data is present or not in the database.
